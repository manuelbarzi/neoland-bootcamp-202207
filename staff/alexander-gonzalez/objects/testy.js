onsole.log('result %c' + result + '%c, expected %c' + expected + ' %c ok ', 'font-weight: bold;', '', 'font-weight: bold;', 'background-color: greenyellow;')
    elseconsole.log('%cTESTY👌%cv0.0', 'color: white; font-size: 24px; font-weight: bold; background: linear-gradient(90deg, rgba(255,0,0,1) 0%, rgba(0,255,0,1) 100%);', 'color: black;')
